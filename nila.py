...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1 WA: 01315591991           '
        time.sleep(2)
        toolbar_width = 25
...
def start():
        try:
            ...
            passw = raw_input('\033[34;1m[\033[37;1m~\033[34;1m]\033[37;1m Wordlist/pass   \033[31;1m:\033[32;1m ')
            total = open(passw, 'r')
